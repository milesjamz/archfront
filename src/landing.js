...
function Landing(props) {
    return (
        <div>
            ...
            <p id="regText">Hello, {props.user.username}! This is a resource that will help you to keep organized and stay productive while the world has ended. Most people are wasting this precious time. But not you, right?!</p>
            <strong>Uses</strong>
